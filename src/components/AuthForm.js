...
const [showPassword, setShowPassword] = useState(false);  // toggle password visibility
 ...
 // Validation: password and confirm password must match in signup
  ...
  return (
    <div className="bg-[#FFF8E1] p-7 rounded-3xl shadow-2xl w-full max-w-md animate-fade-in border border-gray-200">
  ...
  <div className="flex flex-col gap-1">
    ...
    <div className="relative">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-md text-lg font-semibold transition-all shadow-md hover:shadow-lg"
        >
